...
% [simulationTime]
% Duration of the simulation in seconds
[simParams,varargin] = addNewParam(simParams,'DENM_prob',0,'Simulation duration (s)','double',fileCfg,varargin{1});

% [PrioritySPS]
% Duration of the simulation in seconds
[simParams,varargin] = addNewParam(simParams,'Priority_SPS',false,'Priority SPS','bool',fileCfg,varargin{1});

% [PriorityDCC]
% Duration of the simulation in seconds
[simParams,varargin] = addNewParam(simParams,'Priority_DCC',1,'Priority SPS','integer',fileCfg,varargin{1});
