...
if simParams.BRAlgorithm == constants.REASSIGN_BR_STD_MODE_4
    ...
    [timeManagement,stationManagement,sinrManagement,Nreassign,simValues] = ...
        BRreassignment3GPPautonomous(timeManagement,stationManagement,positionManagement,sinrManagement,simParams,phyParams,appParams,outParams,simValues);
...
stationManagement.DENM_list(stationManagement.transmittingIDsCV2X) = 0;
