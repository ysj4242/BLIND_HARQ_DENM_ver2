...
% From v 5.4.14
[fateRxListRawMax,fateRxListRawMax_DENM,fateRxListRawMax_CAM,stationManagement,sinrManagement] = elaborateFateRxCV2X(timeManagement,activeIDsTXLTE,indexInActiveIDsOnlyLTE,neighborsID_LTE,sinrManagement,stationManagement,positionManagement,appParams,phyParams);
