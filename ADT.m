function [timeManagement,stationManagement,sinrManagement] = ADT(timeManagement,vehicle,stationManagement,positionManagement,sinrManagement,appParams,simParams,phyParams,outParams)
...
if ~isempty(vehicle) && timeManagement.elapsedTime_TTIs > nAllocationPeriodsCBR * appParams.NbeaconsT
...
%     sensingMatrix(:,currentT+1:end,:) = circshift(sensingMatrix(:,currentT+1:end,:), 1, 2);
    BRfree = sensingMatrix(1:nAllocationPeriodsCBR,:,vehicle) <= threshCBR_perMHz;
    ...
    BRfree = reshape(permute(BRfree, [2, 1, 3]), appParams.NbeaconsF, [], length(vehicle));
    subchannelFree = true(phyParams.NsubchannelsFrequency, size(BRfree, 2), length(vehicle));
...
if simParams.technology == constants.TECH_COEX_STD_INTERF
    ...
    coex_cbrLTEonlyValues = sinrManagement.cbrLTE_coexLTEonly(vehicle);
else
    coex_cbrLTEonlyValues = sinrManagement.cbrCV2X(vehicle);
end

CBRvalues = sinrManagement.cbrCV2X_ADT(vehicle);
...
if simParams.ADT
    ...
    a = [];
    for s = 1 : length(vehicle)
        if phyParams.cv2xNumberOfReplicasMax>1 && stationManagement.DENM_pck(vehicle(s)) == 1
                % (Vittorio 5.5.3)
                % CR = stationManagement.cv2xNumberOfReplicas(vehicle(i)) * (phyParams.NsubchannelsBeacon)/(phyParams.NsubchannelsFrequency) * phyParams.Tsf / timeManagement.generationInterval(vehicle(i));
                CR = stationManagement.cv2xNumberOfReplicas(vehicle(s)) * (phyParams.NsubchannelsBeacon)/(phyParams.NsubchannelsFrequency) * phyParams.TTI / timeManagement.generationIntervalDeterministicPart(vehicle(s));
                %fprintf('%f\n',CR);
                if simParams.ADT_thr == 1
                    while CBRvalues(s) >= 0.3  && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>1)
%                         if stationManagement.pckNextAttempt(vehicle(s))==2
%                             disp(1)
%                         end
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        stationManagement.DENM_l(vehicle(s)) = 1;
                    end
                
                elseif simParams.ADT_thr == 2
                    while CBRvalues(s) >= 0.8  && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        stationManagement.BRid(vehicle(s),2:phyParams.cv2xNumberOfReplicasMax) = -1;
                        % DENM_l(vehicle(s)) = 1;
                    end
                ...
                elseif simParams.ADT_thr == 3
                    ...
                    while (0.8 > CBRvalues(s)) && (CBRvalues(s) >= 0.75) && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                ...
                elseif simParams.ADT_thr == 4
                    while CBRvalues(s) >= 0.95  && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                    end
                    while (0.95 > CBRvalues(s)) && (CBRvalues(s) >= 0.85) && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                ...
                elseif simParams.ADT_thr == 5
                    while CBRvalues(s) >= 0.85  && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                    end
                    while (0.85 > CBRvalues(s)) && (CBRvalues(s) >= 0.75) && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                ...
                elseif simParams.ADT_thr == 6
                    while CBRvalues(s) >= 0.9  && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                    end
                    while (0.9 > CBRvalues(s)) && (CBRvalues(s) >= 0.7) && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                ...
                elseif simParams.ADT_thr == 7
                    ...
                    while (0.9 > CBRvalues(s)) && (CBRvalues(s) >= 0.65) && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                ...
                elseif simParams.ADT_thr == 8
                    ...
                    while (0.95 > CBRvalues(s)) && (CBRvalues(s) >= 0.9) && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                ...
                elseif simParams.ADT_thr == 9
                    ...
                    while (0.95 > CBRvalues(s)) && (CBRvalues(s) >= 0.87) && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                ...
                elseif simParams.ADT_thr == 10
                    ...
                    while (0.95 > CBRvalues(s)) && (CBRvalues(s) >= 0.8) && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                ...
                elseif simParams.ADT_thr == 11
                    while CBRvalues(s) >= 0.97  && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                    end
                    while (0.97 > CBRvalues(s)) && (CBRvalues(s) >= 0.87) && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                ...
                elseif simParams.ADT_thr == 12
                    ...
                    while (0.97 > CBRvalues(s)) && (CBRvalues(s) >= 0.85) && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                ...
                elseif simParams.ADT_thr == 13
                    ...
                    while (0.97 > CBRvalues(s)) && (CBRvalues(s) >= 0.8) && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                ...
                elseif simParams.ADT_thr == 14
                    while CBRvalues(s) >= 0.92  && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                    end
                    while (0.92 > CBRvalues(s)) && (CBRvalues(s) >= 0.85) && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                ...
                elseif simParams.ADT_thr == 15
                    ...
                    while (0.9 > CBRvalues(s)) && (CBRvalues(s) >= 0.85) && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                ...
                elseif simParams.ADT_thr == 16
                    while CBRvalues(s) >= 0.93  && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                    end
                    while (0.93 > CBRvalues(s)) && (CBRvalues(s) >= 0.85) && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                ...
                elseif simParams.ADT_thr == 17
                    while CBRvalues(s) >= 0.96  && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                    end
                    while (0.96 > CBRvalues(s)) && (CBRvalues(s) >= 0.86) && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                ...
                elseif simParams.ADT_thr == 18
                    ...
                    while (0.96 > CBRvalues(s)) && (CBRvalues(s) >= 0.85) && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                ...
                elseif simParams.ADT_thr == 19
                    ...
                    while (0.95 > CBRvalues(s)) && (CBRvalues(s) >= 0.86) && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                ...
                elseif simParams.ADT_thr == 20
                    ...
                    while (0.97 > CBRvalues(s)) && (CBRvalues(s) >= 0.86) && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                ...
                elseif simParams.ADT_thr == 21
                    ...
                    while (0.96 > CBRvalues(s)) && (CBRvalues(s) >= 0.87) && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                ...
                elseif simParams.ADT_thr == 23
                    while CBRvalues(s) >= 0.95  && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>1)
                        if DENM_l(vehicle(s)) == 0 && stationManagement.cv2xNumberOfReplicas(vehicle(s)) == 2
                            disp(1)
                        end
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        DENM_l(vehicle(s)) = DENM_l(vehicle(s)) + 1;
                        % DENM_l(vehicle(s)) = 1;
                    end
                ...
                elseif simParams.ADT_thr == 25
                    while CBRvalues(s) >= 0.99  && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                 ...
                 elseif simParams.ADT_thr == 26
                    ...
                    while (0.95 > CBRvalues(s)) && (CBRvalues(s) >= 0.93) && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                ...
                elseif simParams.ADT_thr == 27
                    ...
                    while (0.99 > CBRvalues(s)) && (CBRvalues(s) >= 0.95) && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                ...
                elseif simParams.ADT_thr == 28
                    while CBRvalues(s) >= 0.98  && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>1)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                    end
                    while (0.98 > CBRvalues(s)) && (CBRvalues(s) >= 0.95) && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                ...
                elseif simParams.ADT_thr == 29
                    ...
                    while (0.97 > CBRvalues(s)) && (CBRvalues(s) >= 0.95) && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                ...
                elseif simParams.ADT_thr == 30
                    ...
                    while (0.99 > CBRvalues(s)) && (CBRvalues(s) >= 0.96) && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                ...
                elseif simParams.ADT_thr == 31
                    ...
                    while (0.99 > CBRvalues(s)) && (CBRvalues(s) >= 0.97) && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                ...
                elseif simParams.ADT_thr == 32
                    ...
                    while (0.99 > CBRvalues(s)) && (CBRvalues(s) >= 0.98) && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                ...
                elseif simParams.ADT_thr == 33
                    ...
                    while (0.99 > CBRvalues(s)) && (CBRvalues(s) >= 0.94) && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                ...
                elseif simParams.ADT_thr == 34
                    ...
                    while (0.99 > CBRvalues(s)) && (CBRvalues(s) >= 0.93) && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                ...
                elseif simParams.ADT_thr == 35
                    ...
                    while (0.99 > CBRvalues(s)) && (CBRvalues(s) >= 0.92) && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>2)
                        stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                        % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                        stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                        % DENM_l(vehicle(s)) = 1;
                ...
                % while (CR > CRlimit(s)) && (stationManagement.cv2xNumberOfReplicas(vehicle(s))>1)
                %     stationManagement.cv2xNumberOfReplicas(vehicle(s)) = stationManagement.cv2xNumberOfReplicas(vehicle(s))-1;
                %     % stationManagement.pckNextAttempt(vehicle(s)) = 1;
                %     stationManagement.dccLteTriggeredHarq(stationManagement.vehicleChannel(vehicle(s))) = true;
                %     DENM_l(vehicle(s)) = 1;
                ...
                % if stationManagement.pckBuffer(vehicle(s))>0 && ...
                %         stationManagement.pckNextAttempt(vehicle(s)) > stationManagement.cv2xNumberOfReplicas(vehicle(s))
                %     [stationManagement,outputValues] = bufferOverflowLTE(vehicle(s),timeManagement,positionManagement,stationManagement,phyParams,appParams,outputValues,outParams);
                % end
        end
    end
    ...
    % if timeManagement.dcc_minInterval(vehicle)>timeManagement.generationIntervalDeterministicPart(vehicle)
    %     stationManagement.dccLteTriggered(stationManagement.vehicleChannel(vehicle)) = true;
    % end
end
